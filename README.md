# Alvaro Bandim
### Desenvolvedor Python | Automação (RPA) | Engenharia de Dados
...
* **Automação & Web Scraping:** Extração de dados, navegação em DOM HTML (BeautifulSoup, Requests) e controle de throttling.
* **Integrações de Rede & APIs:** Arquitetura Event-Driven, consumo de APIs REST, disparo de webhooks e mensageria (Telegram Bot API, SMTP).
...
## Contato
<p align="left">
  <a href="https://www.linkedin.com/in/alvarobandim/">
    <img src="https://img.shields.io/badge/linkedin-%230077B5.svg?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn" />
  </a>
  <a href="mailto:alvarobandim@hotmail.com">
